...
plt.plot(data.index, data['Close'], label="Bank Nifty Price", color='darkblue', linewidth=2)
...
plt.title('Real-Time Price of Bank Nifty', fontsize=16, color='black', weight='bold')
